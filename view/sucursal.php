...
<div class="container-fluid px-1" id="sucursal">
    <div class="row justify-content-center">

        <div class="col-md-6 text-center mb-5">
            <h2 class="men">Sucursal</h2>
        </div>
    </div>
    <br>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr v-for="row in paginaCollection" style="text-align:center">
                            ...
                            <td>{{row.nombre_empresa}}</span></td>
                            <td>{{row.esactivo}}</td>
                            <td>
                                <button style="background:none;border:none" @click="abrirModal(row.id_sucursal,'Editar', row);"><i class="fa-solid fa-square-pen fa-lg" style="color: #3976c6;"></i></button>
                                <button style="background:none;border:none" @click="eliminarSucursal(row.id_sucursal);"><i class="fa-solid fa-trash fa-lg" style="color: #f50f0f;"></i></button>
    ...
    <b-modal v-model="modal" scrollable no-close-on-backdrop>
            ...
            <div>
                <b-form>
                    <b-form-group class="mb-10 mt-10" label="Nombre:">
                        <b-form-input type="text" v-model="nombre_sucursal" placeholder="Ingresa el nombre" require></b-form-input>
                    </b-form-group>
                    <b-form-group class="mb-10 mt-10" label="Selecciona la Empresa:">
                        <b-form-select v-model="id_empresa" class="mb-3">
        ...
        <div slot="modal-footer" class="w-100">
            <b-button v-if="title == 'Agregar'" variant="success" class="float-right ml-2" @click="insertarSucursal();"><i class="fa-solid fa-floppy-disk"></i></b-button>
            <b-button v-else variant="primary" class="float-right ml-2" @click="editarSucursal();"><i class="fa-regular fa-pen-to-square"></i></b-button>
...
<script type="text/javascript" src="../js/sucursal/sucursal.js"></script>
